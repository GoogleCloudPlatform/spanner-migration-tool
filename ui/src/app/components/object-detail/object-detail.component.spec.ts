...
fdescribe('ObjectDetailComponent', () => {
  ...
  beforeEach(() => {
    ...
    //component.currentObject.name = 'test'
    component.fkData = [{
      spName: 'abc',
      srcName: 'abc',
      spColumns: ['abc_id'],
  ...
  it('should display correct Fk data', () => {
    fixture.detectChanges()
    let fkTable = fixture.debugElement.query(By.css('.mat-column-srcName'))
    expect(fkTable.nativeElement.textContent).toEqual('Name')
  })

  it('should display save buuton on clicking edit', () => {
    component.isEditMode = true
    fixture.detectChanges()
    let saveButton = fixture.debugElement.query(By.css('.column-save-button'))
