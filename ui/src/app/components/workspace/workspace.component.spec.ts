...
describe('WorkspaceComponent', () => {
  ...
  beforeEach(async () => {
    ...
    clickEventSpyObj = jasmine.createSpyObj('ClickEventService', [
      'setViewAssesmentData',
      'setTabToSpanner',
    ])
    sidenavSpyObj = jasmine.createSpyObj('SidenavService', [
      'openSidenav',
      'setSidenavComponent',
      'setSidenavDatabaseName',
      'setMiddleColumnComponent',
    ])
    ...
    dataServiceSpy = jasmine.createSpyObj('DataService', ['getRateTypemapAndSummary'])
  ...
  it('should set currentObject and tableData when type is Table', () => {
    ...
    conversionServiceSpy.getCheckConstrainst
      .withArgs(jasmine.any(String), jasmine.objectContaining<IConv>({}))
      .and.returnValue([])

    conversionServiceSpy.getColumnMapping
      .withArgs(jasmine.any(String), jasmine.objectContaining<IConv>({}))
      .and.returnValue([])
    conversionServiceSpy.getFkMapping
      .withArgs(jasmine.any(String), jasmine.objectContaining<IConv>({}))
      .and.returnValue([])
  ...
  it('should set currentObject and indexData when type is Index', () => {
    ...
    conversionServiceSpy.getIndexMapping
      .withArgs(jasmine.any(String), jasmine.objectContaining<IConv>({}), jasmine.any(String))
      .and.returnValue([])
