...
func TestPrintAutoGenCol(t *testing.T) {
	tests := []struct {
		...
		{AutoGenCol{Name: "testCol", GenerationType: constants.IDENTITY}, " GENERATED BY DEFAULT AS IDENTITY (BIT REVERSED POSITIVE)"},
...
func TestPGPrintIdentityCol(t *testing.T) {
	tests := []struct {
		...
		{
			agc: AutoGenCol{},
			expected: " GENERATED BY DEFAULT AS IDENTITY (BIT REVERSED POSITIVE)",
		},
		{
			agc: AutoGenCol{
			...
			expected: " GENERATED BY DEFAULT AS IDENTITY (BIT REVERSED POSITIVE START COUNTER WITH 10)",
		},
		{
			agc: AutoGenCol{
				IdentityOptions: IdentityOptions{
			...
			expected: " GENERATED BY DEFAULT AS IDENTITY (BIT REVERSED POSITIVE SKIP RANGE 100 250)",
		},
		{
			agc: AutoGenCol{
				IdentityOptions: IdentityOptions{
			...
			expected: " GENERATED BY DEFAULT AS IDENTITY (BIT REVERSED POSITIVE SKIP RANGE 100 250 START COUNTER WITH 10)",
		},
	}
	for _, tc := range tests {
		assert.Equal(t, tc.expected, tc.agc.PrintIdentityCol())
	}
}
