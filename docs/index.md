...
{: .highlight }
We have changed architecture of the minimal downtime migration. There are changes on required permissions to run minimal downtime and Sharded migrations. Please go through [Permissions page](./permissions.md) and [design page](./minimal/minimal.md) of the documentation.
