...
func TestVerifyExpressions(t *testing.T) {
	...
	t.Run("Happy case 1: stagingdb does not exist and expression is successfully verified", func(t *testing.T) {
		...
		ev := &ExpressionVerificationAccessorImpl{SpannerAccessor: SpannerAccessorImpl{SpannerClient: spannerMockClient, AdminClient: spannerAdminMockClient}}
	...
	t.Run("Error in creating staging database", func(t *testing.T) {
		...
		ev := &ExpressionVerificationAccessorImpl{SpannerAccessor: SpannerAccessorImpl{AdminClient: spannerAdminMockClient}}
		output := ev.VerifyExpressions(ctx, input)
	...
	t.Run("Missing Project", func(t *testing.T) {
		badInput := input
		badInput.Project = ""
		ev := &ExpressionVerificationAccessorImpl{SpannerAccessor: SpannerAccessorImpl{}}
