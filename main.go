...
func init() {
	...
	flag.StringVar(&driverName, "driver", "", "driver name: experimental flag for accessing source DB or dump files (accepted values are \"pgdump\", \"postgres\", \"mysqldump\", and \"mysql\")")
...
func main() {
	...
	if dbName == "" {
		dbName, err = getDatabaseName(driverName, now)
		if err != nil {
