...
func TestProcessSchemaOracle(t *testing.T) {
	...
	expectedSchema := map[string]ddl.CreateTable{
		"USER": {
			...
			ColDefs:     map[string]ddl.ColumnDef{"USER_ID": {Name: "USER_ID", T: ddl.Type{Name: ddl.String, Len: ddl.MaxLength, IsArray: false}, NotNull: true, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}}, "NAME": {Name: "NAME", T: ddl.Type{Name: ddl.String, Len: ddl.MaxLength, IsArray: false}, NotNull: true, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}}, "REF": {Name: "REF", T: ddl.Type{Name: ddl.Numeric}, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}}},
		...
		"TEST": {
			...
			ColDefs: map[string]ddl.ColumnDef{
				"ID": {Name: "ID", T: ddl.Type{Name: ddl.Numeric}, NotNull: true, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}}},
		...
		"TEST2": {
			...
			ColDefs: map[string]ddl.ColumnDef{
				"ID":           {Name: "ID", T: ddl.Type{Name: ddl.Numeric}, NotNull: true, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
				"JSON":         {Name: "JSON", T: ddl.Type{Name: ddl.JSON}, NotNull: true, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
				"REALJSON":     {Name: "REALJSON", T: ddl.Type{Name: ddl.JSON}, NotNull: true, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
				"ARRAY_NUM":    {Name: "ARRAY_NUM", T: ddl.Type{Name: ddl.Numeric, IsArray: true}, NotNull: false, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
				"ARRAY_FLOAT":  {Name: "ARRAY_FLOAT", T: ddl.Type{Name: ddl.Float64, IsArray: true}, NotNull: false, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
				"ARRAY_STRING": {Name: "ARRAY_STRING", T: ddl.Type{Name: ddl.String, Len: int64(15), IsArray: true}, NotNull: false, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
				"ARRAY_DATE":   {Name: "ARRAY_DATE", T: ddl.Type{Name: ddl.Date, IsArray: true}, NotNull: false, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
				"ARRAY_INT":    {Name: "ARRAY_INT", T: ddl.Type{Name: ddl.Int64, IsArray: true}, NotNull: false, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
				"OBJECT":       {Name: "OBJECT", T: ddl.Type{Name: ddl.JSON}, NotNull: true, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
			},
			PrimaryKeys: []ddl.IndexKey{{ColId: "ID", Order: 1}},
		},
	}
