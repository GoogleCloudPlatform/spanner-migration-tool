...
func TestToSpannerType(t *testing.T) {
	...
	expected := ddl.CreateTable{
		...
		ColDefs: map[string]ddl.ColumnDef{
			"c1": {Name: "a", Id: "c1", T: ddl.Type{Name: ddl.Numeric}, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
			"c2": {Name: "b", Id: "c2", T: ddl.Type{Name: ddl.Float64}, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
			"c3": {Name: "c", Id: "c3", T: ddl.Type{Name: ddl.Bytes, Len: ddl.MaxLength}, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
			"c4": {Name: "d", Id: "c4", T: ddl.Type{Name: ddl.String, Len: int64(20)}, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
			"c5": {Name: "e", Id: "c5", T: ddl.Type{Name: ddl.Date}, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
			"c6": {Name: "f", Id: "c6", T: ddl.Type{Name: ddl.Timestamp}, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
			"c7": {Name: "g", Id: "c7", T: ddl.Type{Name: ddl.String, Len: ddl.MaxLength}, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
			"c8": {Name: "h", Id: "c8", T: ddl.Type{Name: ddl.Int64}, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
		},
...
func TestToSpannerPostgreSQLDialectType(t *testing.T) {
	...
	expected := ddl.CreateTable{
		...
		ColDefs: map[string]ddl.ColumnDef{
			...
			"c7":  {Name: "g", Id: "c7", T: ddl.Type{Name: ddl.String, Len: ddl.MaxLength}, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
			"c8":  {Name: "h", Id: "c8", T: ddl.Type{Name: ddl.Int64}, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
			"c9":  {Name: "i", Id: "c9", T: ddl.Type{Name: ddl.JSON}, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
			"c10": {Name: "j", Id: "c10", T: ddl.Type{Name: ddl.String, Len: ddl.MaxLength}, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
			"c11": {Name: "k", Id: "c11", T: ddl.Type{Name: ddl.String, Len: ddl.MaxLength}, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
		},
		PrimaryKeys: []ddl.IndexKey{{ColId: "c1"}},
