...
func ProcessDataRow(conv *internal.Conv, tableId string, colIds, vals []string, additionalAttributes internal.AdditionalDataAttributes, mapSrcColIdToVal map[string]string) {
	...
	spCols, spVals, err = transformation.ProcessTransformation(conv, tableId, spCols, spVals, mapSrcColIdToVal, toddl, additionalAttributes)
	if err != nil {
