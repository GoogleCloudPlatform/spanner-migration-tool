...
func TestProcessPgDumpPGTarget(t *testing.T) {
	...
	scalarTests := []struct {
		...
		{"bigint", ddl.Type{Name: ddl.PGInt8}},
		{"bool", ddl.Type{Name: ddl.PGBool}},
		{"boolean", ddl.Type{Name: ddl.PGBool}},
		{"bytea", ddl.Type{Name: ddl.PGBytea, Len: ddl.PGMaxLength}},
		{"char(42)", ddl.Type{Name: ddl.PGVarchar, Len: int64(42)}},
		{"date", ddl.Type{Name: ddl.PGDate}},
		{"decimal", ddl.Type{Name: ddl.PGNumeric}}, // pg parser maps this to numeric.
		{"double precision", ddl.Type{Name: ddl.PGFloat8}},
		{"float8", ddl.Type{Name: ddl.PGFloat8}},
		{"float4", ddl.Type{Name: ddl.PGFloat8}},
		{"integer", ddl.Type{Name: ddl.PGInt8}},
		{"numeric", ddl.Type{Name: ddl.PGNumeric}},
		{"numeric(4)", ddl.Type{Name: ddl.PGNumeric}},
		{"numeric(6, 4)", ddl.Type{Name: ddl.PGNumeric}},
		{"real", ddl.Type{Name: ddl.PGFloat8}},
		{"smallint", ddl.Type{Name: ddl.PGInt8}},
		{"text", ddl.Type{Name: ddl.PGVarchar, Len: ddl.PGMaxLength}},
		{"timestamp", ddl.Type{Name: ddl.PGTimestamptz}},
		{"timestamp without time zone", ddl.Type{Name: ddl.PGTimestamptz}},
		{"timestamp(5)", ddl.Type{Name: ddl.PGTimestamptz}},
		{"timestamptz", ddl.Type{Name: ddl.PGTimestamptz}},
		{"timestamp with time zone", ddl.Type{Name: ddl.PGTimestamptz}},
		{"timestamptz(5)", ddl.Type{Name: ddl.PGTimestamptz}},
		{"varchar", ddl.Type{Name: ddl.PGVarchar, Len: ddl.PGMaxLength}},
		{"varchar(42)", ddl.Type{Name: ddl.PGVarchar, Len: int64(42)}},
	}
	for _, tc := range scalarTests {
	...
	singleColTests := []struct {
		...
		{"text", ddl.ColumnDef{Name: "a", T: ddl.Type{Name: ddl.PGVarchar, Len: ddl.PGMaxLength}}},
		{"text NOT NULL", ddl.ColumnDef{Name: "a", T: ddl.Type{Name: ddl.PGVarchar, Len: ddl.PGMaxLength}, NotNull: true}},
		{"text array[4]", ddl.ColumnDef{Name: "a", T: ddl.Type{Name: ddl.PGVarchar, Len: ddl.PGMaxLength}}},
		{"text[4]", ddl.ColumnDef{Name: "a", T: ddl.Type{Name: ddl.PGVarchar, Len: ddl.PGMaxLength}}},
		{"text[]", ddl.ColumnDef{Name: "a", T: ddl.Type{Name: ddl.PGVarchar, Len: ddl.PGMaxLength}}},
		{"text[][]", ddl.ColumnDef{Name: "a", T: ddl.Type{Name: ddl.PGVarchar, Len: ddl.PGMaxLength}}},
	}
	for _, tc := range singleColTests {
	...
	}{
		{
			...
			expectedSchema: map[string]ddl.CreateTable{
				"cart": ddl.CreateTable{
					...
					ColNames: []string{"productid", "userid", "quantity"},
					ColDefs: map[string]ddl.ColumnDef{
						"productid": ddl.ColumnDef{Name: "productid", T: ddl.Type{Name: ddl.PGVarchar, Len: ddl.PGMaxLength}, NotNull: true},
						"userid":    ddl.ColumnDef{Name: "userid", T: ddl.Type{Name: ddl.PGVarchar, Len: ddl.PGMaxLength}, NotNull: true},
						"quantity":  ddl.ColumnDef{Name: "quantity", T: ddl.Type{Name: ddl.PGInt8}},
					},
					Pks: []ddl.IndexKey{ddl.IndexKey{Col: "productid"}, ddl.IndexKey{Col: "userid"}}}},
		},
		{
			...
			expectedSchema: map[string]ddl.CreateTable{
				"cart": ddl.CreateTable{
					...
					ColNames: []string{"productid", "userid", "quantity", "synth_id"},
					ColDefs: map[string]ddl.ColumnDef{
						"productid": ddl.ColumnDef{Name: "productid", T: ddl.Type{Name: ddl.PGVarchar, Len: ddl.PGMaxLength}},
						"userid":    ddl.ColumnDef{Name: "userid", T: ddl.Type{Name: ddl.PGVarchar, Len: ddl.PGMaxLength}, NotNull: true},
						"quantity":  ddl.ColumnDef{Name: "quantity", T: ddl.Type{Name: ddl.PGInt8}},
						"synth_id":  ddl.ColumnDef{Name: "synth_id", T: ddl.Type{Name: ddl.PGVarchar, Len: 50}},
					},
					Pks: []ddl.IndexKey{ddl.IndexKey{Col: "synth_id"}}}},
		},
		{
			...
			expectedSchema: map[string]ddl.CreateTable{
				"test": ddl.CreateTable{
					...
					ColNames: []string{"a", "b"},
					ColDefs: map[string]ddl.ColumnDef{
						"a": ddl.ColumnDef{Name: "a", T: ddl.Type{Name: ddl.PGVarchar, Len: ddl.PGMaxLength}, NotNull: true},
						"b": ddl.ColumnDef{Name: "b", T: ddl.Type{Name: ddl.PGVarchar, Len: ddl.PGMaxLength}},
					},
					Pks: []ddl.IndexKey{ddl.IndexKey{Col: "a"}}}},
		},
		{
			...
			expectedSchema: map[string]ddl.CreateTable{
				"test": ddl.CreateTable{
					...
					ColDefs: map[string]ddl.ColumnDef{
						"a": ddl.ColumnDef{Name: "a", T: ddl.Type{Name: ddl.PGVarchar, Len: ddl.PGMaxLength}, NotNull: true},
						"b": ddl.ColumnDef{Name: "b", T: ddl.Type{Name: ddl.PGVarchar, Len: ddl.PGMaxLength}, NotNull: true},
						"n": ddl.ColumnDef{Name: "n", T: ddl.Type{Name: ddl.PGInt8}},
					},
					Pks: []ddl.IndexKey{ddl.IndexKey{Col: "a"}, ddl.IndexKey{Col: "b"}}}},
		},
		{
			...
			expectedSchema: map[string]ddl.CreateTable{
				"test": ddl.CreateTable{
					...
					ColNames: []string{"a", "b"},
					ColDefs: map[string]ddl.ColumnDef{
						"a": ddl.ColumnDef{Name: "a", T: ddl.Type{Name: ddl.PGInt8}, NotNull: true},
						"b": ddl.ColumnDef{Name: "b", T: ddl.Type{Name: ddl.PGVarchar, Len: ddl.PGMaxLength}},
					},
					Pks: []ddl.IndexKey{ddl.IndexKey{Col: "a"}}},
				"test2": ddl.CreateTable{
					...
					ColNames: []string{"c", "d", "synth_id"},
					ColDefs: map[string]ddl.ColumnDef{
						"c":        ddl.ColumnDef{Name: "c", T: ddl.Type{Name: ddl.PGInt8}},
						"d":        ddl.ColumnDef{Name: "d", T: ddl.Type{Name: ddl.PGInt8}},
						"synth_id": ddl.ColumnDef{Name: "synth_id", T: ddl.Type{Name: ddl.PGVarchar, Len: 50}},
					},
					Pks: []ddl.IndexKey{ddl.IndexKey{Col: "synth_id"}},
					Fks: []ddl.Foreignkey{ddl.Foreignkey{Name: "fk_test", Columns: []string{"d"}, ReferTable: "test", ReferColumns: []string{"a"}}},
		...
		},
		{
			...
			expectedSchema: map[string]ddl.CreateTable{
				"test": ddl.CreateTable{
					...
					ColDefs: map[string]ddl.ColumnDef{
						"a": ddl.ColumnDef{Name: "a", T: ddl.Type{Name: ddl.PGInt8}, NotNull: true},
						"b": ddl.ColumnDef{Name: "b", T: ddl.Type{Name: ddl.PGInt8}},
						"c": ddl.ColumnDef{Name: "c", T: ddl.Type{Name: ddl.PGVarchar, Len: ddl.PGMaxLength}},
					},
					Pks: []ddl.IndexKey{ddl.IndexKey{Col: "a"}}},
				"test2": ddl.CreateTable{
					Name:     "test2",
		...
		},
		{
			...
			expectedSchema: map[string]ddl.CreateTable{
				...
				"test2": ddl.CreateTable{
					...
					ColNames: []string{"c", "d"},
					ColDefs: map[string]ddl.ColumnDef{
						"c": ddl.ColumnDef{Name: "c", T: ddl.Type{Name: ddl.PGInt8}, NotNull: true},
						"d": ddl.ColumnDef{Name: "d", T: ddl.Type{Name: ddl.PGVarchar, Len: ddl.PGMaxLength}},
					},
					Pks: []ddl.IndexKey{ddl.IndexKey{Col: "c"}}},
				"test3": ddl.CreateTable{
					Name:     "test3",
					ColNames: []string{"e", "f", "g", "synth_id"},
					ColDefs: map[string]ddl.ColumnDef{
						"e":        ddl.ColumnDef{Name: "e", T: ddl.Type{Name: ddl.PGInt8}},
						"f":        ddl.ColumnDef{Name: "f", T: ddl.Type{Name: ddl.PGInt8}},
						"g":        ddl.ColumnDef{Name: "g", T: ddl.Type{Name: ddl.PGVarchar, Len: ddl.PGMaxLength}},
						"synth_id": ddl.ColumnDef{Name: "synth_id", T: ddl.Type{Name: ddl.PGVarchar, Len: 50}},
					},
					Pks: []ddl.IndexKey{ddl.IndexKey{Col: "synth_id"}},
					Fks: []ddl.Foreignkey{ddl.Foreignkey{Name: "fk_test", Columns: []string{"e"}, ReferTable: "test", ReferColumns: []string{"a"}},
		...
		},
		{
			...
			expectedSchema: map[string]ddl.CreateTable{
				...
				"t2": ddl.CreateTable{
					...
					ColNames: []string{"c"},
					ColDefs: map[string]ddl.ColumnDef{
						"c": ddl.ColumnDef{Name: "c", T: ddl.Type{Name: ddl.PGVarchar, Len: ddl.PGMaxLength}, NotNull: true}},
					Pks: []ddl.IndexKey{ddl.IndexKey{Col: "c"}}}},
		},
		{
			name: "COPY FROM",
		...
		},
		{
			...
			expectedSchema: map[string]ddl.CreateTable{
				"te_s_t": ddl.CreateTable{
					...
					ColNames: []string{"a__", "b_b", "n_n"},
					ColDefs: map[string]ddl.ColumnDef{
						"a__": ddl.ColumnDef{Name: "a__", T: ddl.Type{Name: ddl.PGVarchar, Len: ddl.PGMaxLength}, NotNull: true},
						"b_b": ddl.ColumnDef{Name: "b_b", T: ddl.Type{Name: ddl.PGVarchar, Len: ddl.PGMaxLength}},
						"n_n": ddl.ColumnDef{Name: "n_n", T: ddl.Type{Name: ddl.PGInt8}},
					},
					Pks: []ddl.IndexKey{ddl.IndexKey{Col: "a__"}}}},
		},
		{
