...
func TestConvertData(t *testing.T) {
	singleColTests := []struct {
		...
		{"numeric array pg", ddl.Type{Name: ddl.Numeric, IsArray: true}, "numeric_arr", `{"32.3213",NULL}`, []interface{}{
			spanner.PGNumeric{Numeric: "32.3213", Valid: true},
			spanner.PGNumeric{Valid: false}}},
