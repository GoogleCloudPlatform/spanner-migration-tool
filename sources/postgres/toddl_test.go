...
func TestToSpannerType(t *testing.T) {
	...
	expected := ddl.CreateTable{
		...
		ColDefs: map[string]ddl.ColumnDef{
			"c1": ddl.ColumnDef{Name: "a", Id: "c1", T: ddl.Type{Name: ddl.Int64}, AutoGen: ddl.AutoGenCol{Type: "None", Name: "None"}},
			"c2": ddl.ColumnDef{Name: "b", Id: "c2", T: ddl.Type{Name: ddl.Float64}, AutoGen: ddl.AutoGenCol{Type: "None", Name: "None"}},
			"c3": ddl.ColumnDef{Name: "c", Id: "c3", T: ddl.Type{Name: ddl.Bool}, AutoGen: ddl.AutoGenCol{Type: "None", Name: "None"}},
			"c4": ddl.ColumnDef{Name: "d", Id: "c4", T: ddl.Type{Name: ddl.String, Len: int64(6)}, AutoGen: ddl.AutoGenCol{Type: "None", Name: "None"}},
			"c5": ddl.ColumnDef{Name: "e", Id: "c5", T: ddl.Type{Name: ddl.Numeric}, AutoGen: ddl.AutoGenCol{Type: "None", Name: "None"}},
			"c6": ddl.ColumnDef{Name: "f", Id: "c6", T: ddl.Type{Name: ddl.Timestamp}, AutoGen: ddl.AutoGenCol{Type: "None", Name: "None"}},
		},
...
func TestToExperimentalSpannerType(t *testing.T) {
	...
	expected := ddl.CreateTable{
		...
		ColDefs: map[string]ddl.ColumnDef{
			...
			"c4": ddl.ColumnDef{Name: "d", Id: "c4", T: ddl.Type{Name: ddl.String, Len: int64(6)}, AutoGen: ddl.AutoGenCol{Type: "None", Name: "None"}},
			"c5": ddl.ColumnDef{Name: "e", Id: "c5", T: ddl.Type{Name: ddl.Numeric}, AutoGen: ddl.AutoGenCol{Type: "None", Name: "None"}},
			"c6": ddl.ColumnDef{Name: "f", Id: "c6", T: ddl.Type{Name: ddl.Date}, AutoGen: ddl.AutoGenCol{Type: "None", Name: "None"}},
			"c7": ddl.ColumnDef{Name: "g", Id: "c7", T: ddl.Type{Name: ddl.JSON}, AutoGen: ddl.AutoGenCol{Type: "None", Name: "None"}},
		},
		PrimaryKeys: []ddl.IndexKey{ddl.IndexKey{ColId: "c1"}},
		ForeignKeys: []ddl.Foreignkey{ddl.Foreignkey{Name: "fk_test", ColIds: []string{"c4"}, ReferTableId: "t2", ReferColumnIds: []string{"c7"}},
			ddl.Foreignkey{Name: "fk_test2", ColIds: []string{"c1"}, ReferTableId: "t3", ReferColumnIds: []string{"c10"}}},
