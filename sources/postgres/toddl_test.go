...
func TestToSpannerType(t *testing.T) {
	...
	srcSchema := schema.Table{
		...
		ForeignKeys: []schema.ForeignKey{schema.ForeignKey{Name: "fk_test", ColIds: []string{"c4"}, ReferTableId: "t2", ReferColumnIds: []string{"c7"}, OnDelete: constants.RESTRICT, OnUpdate: constants.NO_ACTION},
			schema.ForeignKey{Name: "fk_test2", ColIds: []string{"c1"}, ReferTableId: "t3", ReferColumnIds: []string{"c10"}, OnDelete: constants.CASCADE, OnUpdate: constants.SET_DEFAULT}},
	...
	expected := ddl.CreateTable{
		...
		ForeignKeys: []ddl.Foreignkey{ddl.Foreignkey{Name: "fk_test", ColIds: []string{"c4"}, ReferTableId: "t2", ReferColumnIds: []string{"c7"}, OnDelete: constants.NO_ACTION, OnUpdate: constants.NO_ACTION},
			ddl.Foreignkey{Name: "fk_test2", ColIds: []string{"c1"}, ReferTableId: "t3", ReferColumnIds: []string{"c10"}, OnDelete: constants.CASCADE, OnUpdate: constants.NO_ACTION}},
...
func TestToExperimentalSpannerType(t *testing.T) {
	...
	srcSchema := schema.Table{
		...
		PrimaryKeys: []schema.Key{schema.Key{ColId: "c1"}},
		ForeignKeys: []schema.ForeignKey{schema.ForeignKey{Name: "fk_test", ColIds: []string{"c4"}, ReferTableId: "t2", ReferColumnIds: []string{"c7"}, OnDelete: constants.NO_ACTION, OnUpdate: constants.NO_ACTION},
			schema.ForeignKey{Name: "fk_test2", ColIds: []string{"c1"}, ReferTableId: "t3", ReferColumnIds: []string{"c10"}, OnDelete: constants.RESTRICT, OnUpdate: constants.CASCADE}},
		Indexes: []schema.Index{schema.Index{Name: "index1", Unique: true, Keys: []schema.Key{schema.Key{ColId: "c1", Desc: false}, schema.Key{ColId: "c4", Desc: true}}},
			schema.Index{Name: "index2", Unique: false, Keys: []schema.Key{schema.Key{ColId: "c4", Desc: true}}}},
	}
	conv.SrcSchema[tableId] = srcSchema
