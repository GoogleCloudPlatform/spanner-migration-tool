...
func TestConvertSqlRow_SingleCol(t *testing.T) {
	...
	tc := []struct {
		...
		{name: "bytes string", srcType: schema.Type{Name: "bytea"}, spType: ddl.Type{Name: ddl.Bytes, Len: ddl.MaxLength}, in: "abc", e: []byte("abc")},
		{name: "numeric string", srcType: schema.Type{Name: "numeric"}, spType: ddl.Type{Name: ddl.Numeric}, in: "9999999999999999999999999999.999999999", e: func() *big.Rat { r, _ := new(big.Rat).SetString("9999999999999999999999999999.999999999"); return r }()},
		{name: "numeric float64", srcType: schema.Type{Name: "numeric"}, spType: ddl.Type{Name: ddl.Numeric}, in: float64(-999.99), e: big.NewRat(-99999, 100)},
		{name: "numeric int64", srcType: schema.Type{Name: "numeric"}, spType: ddl.Type{Name: ddl.Numeric}, in: int64(-999), e: big.NewRat(-999, 1)},
		{name: "numeric float32", srcType: schema.Type{Name: "numeric"}, spType: ddl.Type{Name: ddl.Numeric}, in: float32(999), e: big.NewRat(999, 1)},
		{name: "uuid string", srcType: schema.Type{Name: "uuid"}, spType: ddl.Type{Name: ddl.UUID}, in: "A0EEBC99-9C0B-4EF8-BB6D-6BB9BD380A11", e: "A0EEBC99-9C0B-4EF8-BB6D-6BB9BD380A11"},
		{name: "uuid byte", srcType: schema.Type{Name: "uuid"}, spType: ddl.Type{Name: ddl.UUID}, in: []byte("a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11"), e: "a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11"},
