...
func TestToSpannerType(t *testing.T) {
	...
	srcSchema := schema.Table{
		...
		ColDefs: map[string]schema.Column{
			...
			"i": {Name: "i", Type: schema.Type{Name: "timestamp"}},
			"j": {Name: "j", Type: schema.Type{Name: "bit"}},
		},
	...
	expected := ddl.CreateTable{
		...
		ColDefs: map[string]ddl.ColumnDef{
			...
			"g": {Name: "g", T: ddl.Type{Name: ddl.JSON}},
			"h": {Name: "h", T: ddl.Type{Name: ddl.Date}},
			"i": {Name: "i", T: ddl.Type{Name: ddl.Timestamp}},
			"j": {Name: "j", T: ddl.Type{Name: ddl.Bytes, Len: ddl.MaxLength}},
		},
