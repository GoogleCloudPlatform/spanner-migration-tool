...
func TestProcessMySQLDump_SingleCol(t *testing.T) {
	...
	singleColTests := []struct {
		...
		{"set('a','b','c')", ddl.ColumnDef{Name: "a", T: ddl.Type{Name: "STRING", Len: 9223372036854775807, IsArray: false}, NotNull: false, Comment: "", AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}}},
		...
		},
		{
			...
			expectedSchema: map[string]ddl.CreateTable{
				"cart": {
					...
					ColDefs: map[string]ddl.ColumnDef{
						"productid": {Name: "productid", T: ddl.Type{Name: ddl.String, Len: ddl.MaxLength}, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
						"userid":    {Name: "userid", T: ddl.Type{Name: ddl.String, Len: ddl.MaxLength}, NotNull: true, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
						"quantity":  {Name: "quantity", T: ddl.Type{Name: ddl.Int64}, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
			...
			expectedSchema: map[string]ddl.CreateTable{
				"test": {
					...
					ColDefs: map[string]ddl.ColumnDef{
						...
						"b": {Name: "b", T: ddl.Type{Name: ddl.String, Len: ddl.MaxLength}, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
					},
		...
		},
		{
			...
			expectedSchema: map[string]ddl.CreateTable{
				"test": {
					...
					ColDefs: map[string]ddl.ColumnDef{
						"a": {Name: "a", T: ddl.Type{Name: ddl.String, Len: ddl.MaxLength}, NotNull: true, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
						"b": {Name: "b", T: ddl.Type{Name: ddl.String, Len: ddl.MaxLength}, NotNull: true, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
						"n": {Name: "n", T: ddl.Type{Name: ddl.Int64}, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
					},
		...
		},
		{
			...
			expectedSchema: map[string]ddl.CreateTable{
				"test": {
					...
					ColIds: []string{"a", "b"},
					ColDefs: map[string]ddl.ColumnDef{
						"a": {Name: "a", T: ddl.Type{Name: ddl.Int64}, NotNull: true, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
						"b": {Name: "b", T: ddl.Type{Name: ddl.String, Len: ddl.MaxLength}, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
					},
					PrimaryKeys: []ddl.IndexKey{{ColId: "a", Order: 1}}},
				"test2": {
					...
					ColDefs: map[string]ddl.ColumnDef{
						...
						"d":        {Name: "d", T: ddl.Type{Name: ddl.Int64}, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
						"synth_id": {Name: "synth_id", T: ddl.Type{Name: ddl.String, Len: 50}, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
					},
					PrimaryKeys: []ddl.IndexKey{{ColId: "synth_id", Order: 1}},
		...
		},
		{
			...
			expectedSchema: map[string]ddl.CreateTable{
				...
				"test3": ddl.CreateTable{
					...
					ColIds: []string{"e", "f"},
					ColDefs: map[string]ddl.ColumnDef{
						"e": ddl.ColumnDef{Name: "e", T: ddl.Type{Name: ddl.Int64}, NotNull: true, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
						"f": ddl.ColumnDef{Name: "f", T: ddl.Type{Name: ddl.String, Len: ddl.MaxLength}, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
					},
		...
		},
		{
			...
			expectedSchema: map[string]ddl.CreateTable{
				"te_s_t": ddl.CreateTable{
					...
					ColDefs: map[string]ddl.ColumnDef{
						"a__": ddl.ColumnDef{Name: "a__", T: ddl.Type{Name: ddl.String, Len: ddl.MaxLength}, NotNull: true, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
						"b_b": ddl.ColumnDef{Name: "b_b", T: ddl.Type{Name: ddl.String, Len: ddl.MaxLength}, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
						"n_n": ddl.ColumnDef{Name: "n_n", T: ddl.Type{Name: ddl.Int64}, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
					},
			...
			expectedSchema: map[string]ddl.CreateTable{
				"cart": ddl.CreateTable{
					...
					ColDefs: map[string]ddl.ColumnDef{
						...
						"userid":    ddl.ColumnDef{Name: "userid", T: ddl.Type{Name: ddl.String, Len: ddl.MaxLength}, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
		...
		},
		{
			...
			expectedSchema: map[string]ddl.CreateTable{
				"test": ddl.CreateTable{
					...
					ColDefs: map[string]ddl.ColumnDef{
						"synth_id":  ddl.ColumnDef{Name: "synth_id", T: ddl.Type{Name: ddl.String, Len: ddl.MaxLength}, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
						"synth_id0": ddl.ColumnDef{Name: "synth_id0", T: ddl.Type{Name: ddl.String, Len: ddl.MaxLength}, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
						"synth_id1": ddl.ColumnDef{Name: "synth_id1", T: ddl.Type{Name: ddl.Int64}, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
						"synth_id2": ddl.ColumnDef{Name: "synth_id2", T: ddl.Type{Name: ddl.String, Len: 50}, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
					},
