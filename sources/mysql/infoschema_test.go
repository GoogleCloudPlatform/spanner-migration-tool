...
func TestProcessSchemaMYSQL(t *testing.T) {
	...
	expectedSchema := map[string]schema.Table{
		"cart": schema.Table{Name: "cart", Schema: "test", ColIds: []string{"productid", "userid", "quantity", "defval_2"}, ColDefs: map[string]schema.Column{
			...
			"defval_2": schema.Column{Name: "defval_2", Type: schema.Type{Name: "varchar", Mods: []int64(nil), ArrayBounds: []int64(nil)}, NotNull: false, Ignored: schema.Ignored{Check: false, Identity: false, Default: true, Exclusion: false, ForeignKey: false, AutoIncrement: false}, Id: "", DefaultValue: schema.DefaultValue{IsPresent: true, Value: "John"}}},
		...
		"product": schema.Table{Name: "product", Schema: "test", ColIds: []string{"product_id", "product_name", "defval_3"}, ColDefs: map[string]schema.Column{
			...
			"defval_3": schema.Column{Name: "defval_3", Type: schema.Type{Name: "varchar", Mods: []int64(nil), ArrayBounds: []int64(nil)}, NotNull: false, Ignored: schema.Ignored{Check: false, Identity: false, Default: true, Exclusion: false, ForeignKey: false, AutoIncrement: false}, Id: "", DefaultValue: schema.DefaultValue{IsPresent: true, Value: "John"}}},
		...
		"test": schema.Table{Name: "test", Schema: "test", ColIds: []string{"id", "s", "txt", "b", "bs", "bl", "c", "c8", "d", "dec", "f8", "f4", "i8", "i4", "i2", "si", "ts", "tz", "vc", "vc6", "def"}, ColDefs: map[string]schema.Column{
			...
			"def": schema.Column{Name: "def", Type: schema.Type{Name: "varchar", Mods: []int64(nil), ArrayBounds: []int64(nil)}, NotNull: false, Ignored: schema.Ignored{Check: false, Identity: false, Default: true, Exclusion: false, ForeignKey: false, AutoIncrement: false}, Id: "", DefaultValue: schema.DefaultValue{IsPresent: true, Value: "John"}}},
		...
		"test_ref": schema.Table{Name: "test_ref", Schema: "test", ColIds: []string{"ref_id", "ref_txt", "abc", "defval_4"}, ColDefs: map[string]schema.Column{
			...
			"defval_4": schema.Column{Name: "defval_4", Type: schema.Type{Name: "varchar", Mods: []int64(nil), ArrayBounds: []int64(nil)}, NotNull: false, Ignored: schema.Ignored{Check: false, Identity: false, Default: true, Exclusion: false, ForeignKey: false, AutoIncrement: false}, Id: "", DefaultValue: schema.DefaultValue{IsPresent: true, Value: "John"}}},
		...
		"user": schema.Table{Name: "user", Schema: "test", ColIds: []string{"user_id", "name", "ref", "defval_1"}, ColDefs: map[string]schema.Column{
			...
			"defval_1": schema.Column{Name: "defval_1", Type: schema.Type{Name: "varchar", Mods: []int64(nil), ArrayBounds: []int64(nil)}, NotNull: false, Ignored: schema.Ignored{Check: false, Identity: false, Default: true, Exclusion: false, ForeignKey: false, AutoIncrement: false}, Id: "", DefaultValue: schema.DefaultValue{IsPresent: true, Value: "John"}}},
