...
func toType(dataType string, columnType string, charLen sql.NullInt64, numericPrecision, numericScale sql.NullInt64) schema.Type {
	switch {
	case dataType == "set":
		return schema.Type{Name: dataType, FullName: columnType, ArrayBounds: []int64{-1}}
	case charLen.Valid:
		return schema.Type{Name: dataType, FullName: columnType, Mods: []int64{charLen.Int64}}
	...
	case dataType == "tinyint" && len(columnType) > len("tinyint"):
		...
		if err != nil {
			return schema.Type{Name: dataType, FullName: columnType}
		}
		return schema.Type{Name: dataType, FullName: columnType, Mods: []int64{length}}
	case numericPrecision.Valid && numericScale.Valid && numericScale.Int64 != 0:
		return schema.Type{Name: dataType, FullName: columnType, Mods: []int64{numericPrecision.Int64, numericScale.Int64}}
	case numericPrecision.Valid:
		return schema.Type{Name: dataType, FullName: columnType, Mods: []int64{numericPrecision.Int64}}
	default:
		return schema.Type{Name: dataType, FullName: columnType}
	}
}
