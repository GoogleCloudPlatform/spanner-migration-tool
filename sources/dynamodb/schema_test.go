...
func TestProcessSchema(t *testing.T) {
	...
	err := processSchema.ProcessSchema(conv, InfoSchemaImpl{client, nil, sampleSize}, 1, internal.AdditionalSchemaAttributes{}, common.GetSchemaToSpannerImpl(conv), &common.UtilsOrderImpl{}, &common.InfoSchemaImpl{})
