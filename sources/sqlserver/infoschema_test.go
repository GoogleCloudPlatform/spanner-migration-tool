...
func TestProcessSchema(t *testing.T) {
	...
	err := processSchema.ProcessSchema(conv, InfoSchemaImpl{"test", db}, 1, internal.AdditionalSchemaAttributes{}, common.GetSchemaToSpannerImpl(conv), &common.UtilsOrderImpl{}, &common.InfoSchemaImpl{})
	assert.Nil(t, err)
