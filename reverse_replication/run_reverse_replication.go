...
func setupGlobalFlags() {
	...
	flag.StringVar(&metadataDatabase, "metadataDatabase", "change_stream_metadata", "spanner database name to store changestream metadata, defaults to change-stream-metadata.")
	...
	flag.StringVar(&gcsPath, "gcsPath", "gs://reverse-replication/buffer", "The GCS directory where the change stream data resides.Default is gs://reverse-replication/buffer.")
