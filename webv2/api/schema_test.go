	...
	}{
		{
			...
			conv: &internal.Conv{
				SpSchema: map[string]ddl.CreateTable{"t1": {
					...
					ForeignKeys: []ddl.Foreignkey{ddl.Foreignkey{Name: "fk1", ColIds: []string{"c1"}, ReferTableId: "t2", ReferColumnIds: []string{"c4"}, OnDelete: "CASCADE", OnUpdate: "NO ACTION"}},
...
func TestDropForeignKey(t *testing.T) {
	tc := []struct {
	...
	}{
		{
			...
			table: "t1",
			input: []ddl.Foreignkey{{Name: "fk1", ColIds: []string{"c2"}, ReferTableId: "reft1", ReferColumnIds: []string{"ref_c1"}, Id: "f1", OnDelete: "CASCADE", OnUpdate: "NO ACTION"},
				{Name: "", ColIds: []string{}, ReferTableId: "", ReferColumnIds: []string{}, Id: "f2", OnDelete: "NO ACTION", OnUpdate: "NO ACTION"}},
			statusCode: http.StatusOK,
			conv: &internal.Conv{
				SpSchema: map[string]ddl.CreateTable{
					"t1": {
						ForeignKeys: []ddl.Foreignkey{{Name: "fk1", ColIds: []string{"c2"}, ReferTableId: "reft1", ReferColumnIds: []string{"ref_c1"}, Id: "f1", OnDelete: "CASCADE", OnUpdate: "NO ACTION"},
							{Name: "fk2", ColIds: []string{"c3", "c4"}, ReferTableId: "reft2", ReferColumnIds: []string{"ref_c2", "ref_c3"}, Id: "f2", OnDelete: "NO ACTION", OnUpdate: "NO ACTION"}},
					}},
