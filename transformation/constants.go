...
var SupportedFunctionsConst = SupportedFunctions{
	Functions: map[string]FunctionDefinition{
		...
		NoOp: {
			...
			Comment:     "",
			Input: [][]string{
				{ddl.Int64, ddl.Float64, ddl.Bool, ddl.Date, ddl.JSON, ddl.Numeric, ddl.Date, ddl.Timestamp, ddl.String},
			},
			Output: []string{ddl.Int64, ddl.Float64, ddl.Bool, ddl.Date, ddl.JSON, ddl.Numeric, ddl.Date, ddl.Timestamp, ddl.String},
		},
		BitReverse: {
			Name:        BitReverse,
