class TableCarousel extends HTMLElement {
    ...
    render() {
        ...
        Table: <span>${title}</span> <i class="fas fa-angle-down rotate-icon"></i>
    </a>
    ...
    <span class='spanner-text right-align hide-content'>Spanner</span>
                        ...
                        <div class='collapse reportCollapse' id="${title}">
                                ...
                                <div class='acc-card-content' id='acc_card_content'>
                                    ...
                                    <div class='summaryCard'>
                                        <div class='summaryCardHeader' role='tab'>
                                            <h5 class='mb-0'>
                                                <a data-toggle='collapse' class='summaryFont'>View
                                                    Summary</a>
                                            </h5>
                                        </div>
