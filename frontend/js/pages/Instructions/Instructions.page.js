    ...
    render() {
        this.innerHTML = `
            <div class="instructionsDiv">
                <img src='Icons/Icons/google-spanner-logo.png' class="instructionsIcon" />
                <h1 class="textCenter">HarbourBridge User Manual</h1>
                <br><br>
                <h3 class="instructionsMainHeading">1 &nbsp; &nbsp; &nbsp;Introduction</h3>
                ...
                <br>
                <h4 class="instructionsSubHeading">1.1 &nbsp; &nbsp; &nbsp;HarbourBridge UI</h4>
                ...
                <br>
                <h3 class="instructionsMainHeading">2 &nbsp; &nbsp; &nbsp;Key Features of UI</h3>
                <ul>
                ...
                <h3 class="instructionsMainHeading">3 &nbsp; &nbsp; &nbsp;UI Setup</h3>
                <ul>
                    <li>- Install go in local</li>
                    <li>- Clone harbourbridge project and run following command in the terminal: <br>
                        <span class="instructionsCommand">go run main.go --web</span>
                    </li>
                    <li>- Open <span class="instructionsCommand">http://localhost:8080</span>in browser</li>
                </ul>
                <br>

                <h3 class="instructionsMainHeading">4 &nbsp; &nbsp; &nbsp;Different modes to select
                    source database</h3>
                <h4 class="instructionsSubHeading">4.1 &nbsp; &nbsp; &nbsp;Connect to Database</h4>
                <ul>
