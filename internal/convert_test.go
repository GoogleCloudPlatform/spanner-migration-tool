		...
		},
		{
			...
			inputSchema: map[string]ddl.CreateTable{
				"t1": {
					...
					ColDefs: map[string]ddl.ColumnDef{
						"c11111": {Name: "a", Id: "c11111", T: ddl.Type{Name: ddl.Int64}, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
						"c22222": {Name: "b", Id: "c22222", T: ddl.Type{Name: ddl.Float64}, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
					},
					PrimaryKeys: []ddl.IndexKey{},
			...
			expectedSchema: map[string]ddl.CreateTable{
				"table": {
					...
					ColDefs: map[string]ddl.ColumnDef{
						"a":        {Name: "a", T: ddl.Type{Name: ddl.Int64}, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
						"b":        {Name: "b", T: ddl.Type{Name: ddl.Float64}, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
						"synth_id": {Name: "synth_id", T: ddl.Type{Name: "STRING", Len: 50, IsArray: false}, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
					},
			...
			expectedSchema: map[string]ddl.CreateTable{
				"table": {
					...
					ColDefs: map[string]ddl.ColumnDef{
						"a":        {Name: "a", T: ddl.Type{Name: ddl.Int64}, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
						"b":        {Name: "b", T: ddl.Type{Name: ddl.Float64}, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
						"synth_id": {Name: "synth_id", T: ddl.Type{Name: ddl.String, Len: 50, IsArray: false}, AutoGen: ddl.AutoGenCol{Name: "None", Type: "None"}},
					},
					PrimaryKeys: []ddl.IndexKey{{ColId: "synth_id", Order: 1}}},
			},
			syntheticKey: "synth_id",
